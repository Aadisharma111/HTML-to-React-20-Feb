...
export default function Index() {
  ...
  <nav classname="navbar navbar-expand-lg navbar-dark bg-dark">
    <div classname="container px-5">
      ...
      <button classnamenamenamenamename="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation"><span className="navbar-toggler-icon" /></button>
      ...
      <div classname="row gx-5 align-items-center justify-content-center">
        <div classname="col-lg-8 col-xl-7 col-xxl-6">
          <div classname="my-5 text-center text-xl-start">
            <h1 classname="display-5 fw-bolder text-white mb-2">A Bootstrap 5 template htmlFor modern businesses</h1>
        ...
        <div classname="col-lg-8">
          <div classname="row gx-5 row-cols-1 row-cols-md-2">
            <div classname="col mb-5 h-100">
              <div classnamenamenamenamename="feature bg-primary bg-gradient text-white rounded-3 mb-3"><i className="bi bi-collection" /></div>
            ...
            <div classname="col mb-5 h-100">
              <div classnamenamenamenamename="feature bg-primary bg-gradient text-white rounded-3 mb-3"><i className="bi bi-building" /></div>
              <h2 classname="h5">Featured title</h2>
              <p classname="mb-0">Paragraph of text beneath the heading to explain the heading. Here is just a bit more text.</p>
            </div>
            <div classname="col mb-5 mb-md-0 h-100">
              <div classnamenamenamenamename="feature bg-primary bg-gradient text-white rounded-3 mb-3"><i className="bi bi-toggles2" /></div>
              <h2 classname="h5">Featured title</h2>
              <p classname="mb-0">Paragraph of text beneath the heading to explain the heading. Here is just a bit more text.</p>
            </div>
        ...
        <div classname="col-lg-4 mb-5">
          <div classname="card h-100 shadow border-0">
            ...
            <div classname="card-body p-4">
              ...
              <a classnamenamenamenamename="text-decoration-none link-dark stretched-link" href="#!"><h5 className="card-title mb-3">Blog post title</h5></a>
        ...
        <div classname="col-lg-4 mb-5">
          <div classname="card h-100 shadow border-0">
            ...
            <div classname="card-body p-4">
              ...
              <a classnamenamenamenamename="text-decoration-none link-dark stretched-link" href="#!"><h5 className="card-title mb-3">Another blog post title</h5></a>
      ...
      <aside classname="bg-primary bg-gradient rounded-3 p-4 p-sm-5 mt-5">
        <div classname="d-flex align-items-center justify-content-between flex-column flex-xl-row text-center text-xl-start">
          <div classname="mb-4 mb-xl-0">
            ...
            <div classname="text-white-50">Sign up htmlFor our newsletter htmlFor the latest updates.</div>
          </div>
  ...
  <footer classname="bg-dark py-4 mt-auto">
    <div classname="container px-5">
      <div classname="row align-items-center justify-content-between flex-column flex-sm-row">
        <div classnamenamenamenamename="col-auto"><div className="small m-0 text-white">Copyright © Your Website 2022</div></div>
